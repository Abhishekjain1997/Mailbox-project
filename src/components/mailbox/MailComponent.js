  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch(
        `https://mailbox-client-ac835-default-rtdb.firebaseio.com/${changedSenderMail}SentMail.json`,
        {
          method: "POST",
    ...
    try {
      ...
      const response = await fetch(
        `https://mailbox-client-ac835-default-rtdb.firebaseio.com/${mail}Inbox.json`,
        {
          method: "POST",
          body: JSON.stringify({
            from: senderEmail,
      ...
      <Modal
        ...
        <div className="bg-light custom-modal-content">
          <Modal.Header closeButton>
            <Modal.Title className="text-center text-dark w-100">
              Compose Mail
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
